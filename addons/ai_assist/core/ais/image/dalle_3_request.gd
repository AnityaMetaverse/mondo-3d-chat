...
static func get_default_options() -> Dictionary:
	var options := {}
	options["image_generation/dalle_3/dimensions"] = 2
	options["image_generation/dalle_3/samples"] = 1
	options["image_generation/dalle_3/quality"] = 0
	options["image_generation/dalle_3/style"] = 0

	return options


func set_options(options: Dictionary) -> void:
	dimensions = options["image_generation/dalle_3/dimensions"]
	samples = options["image_generation/dalle_3/samples"]
	quality = options["image_generation/dalle_3/quality"]
	style = options["image_generation/dalle_3/style"]
